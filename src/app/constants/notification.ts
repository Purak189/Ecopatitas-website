export function Notification(client: any) {
				...
				<td align="center">
					<a target="_blank" rel="noopener noreferrer" href="https://dilvant.com/">
						<img style="max-width: 640px; margin-top: 25px;"
							src="https://objects-us-east-1.dream.io/augurdigital/josle/title-2.png" alt="title" />
					</a>
				</td>
			...
			<tr>
				...
				">
						<div style="text-align: left">
							...
							<p style="font-size: 14px; font-style: normal; font-weight: 300; line-height: 150%">
								Se ha recibido una Reclamación. A continuación, se detallan los datos:
							</p>
							...
							<p style="font-size: 14px; font-style: normal; font-weight: 300; line-height: 150%">
								Revisar el reclamo/queja durante los siguientes días y comunicarse con el comprador.
							</p>
